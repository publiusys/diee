...
def run():
    ...
    clientOut1 = runRemoteCommand(f"docker run -i --rm --name web_search_client --net host cloudsuite/web-search:client {TBENCH_SERVER} {TBENCH_QPS} --interval-min=500 --interval-max=500 --output-query-result", "192.168.1.1")
