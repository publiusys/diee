...
function runMult() {
    NTRIALS=40 MQPS=1400 PERCENTILE=99 LATENCY=10000 run
    #NTRIALS=40 MQPS=1500 PERCENTILE=90 LATENCY=5000 run
    ...
    #NTRIALS=40 MQPS=2500 PERCENTILE=90 LATENCY=5000 run
