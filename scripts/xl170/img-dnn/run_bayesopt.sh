...
function runMult() {
    NTRIALS=60 MQPS=1500 PERCENTILE=90 LATENCY=5000 run
    NTRIALS=60 MQPS=2000 PERCENTILE=99 LATENCY=5000 run
    NTRIALS=60 MQPS=2000 PERCENTILE=90 LATENCY=5000 run
    NTRIALS=60 MQPS=2500 PERCENTILE=99 LATENCY=5000 run
    NTRIALS=60 MQPS=2500 PERCENTILE=90 LATENCY=5000 run
    NTRIALS=60 MQPS=3000 PERCENTILE=99 LATENCY=5000 run
    NTRIALS=60 MQPS=3000 PERCENTILE=90 LATENCY=5000 run
}
