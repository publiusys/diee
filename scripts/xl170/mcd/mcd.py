...
def run():
    ...
    runRemoteCommands("~/mutilate/mutilate --agentmode --threads=10", "192.168.1.2")
    runRemoteCommands("~/mutilate/mutilate --agentmode --threads=10", "192.168.1.3")
    runRemoteCommands("~/mutilate/mutilate --agentmode --threads=10", "192.168.1.4")
    time.sleep(1)
    ...
    if not is_running_mcd:
        print(f"rerunning mcd taskset -c 0-9 ~/memcached/memcached -u nobody -t 10 -m 32G -c 8192 -b 8192 -l {TBENCH_SERVER} -B binary")
        runRemoteCommands(f"taskset -c 0-9 ~/memcached/memcached -u nobody -t 10 -m 32G -c 8192 -b 8192 -l {TBENCH_SERVER} -B binary", TBENCH_SERVER)
        time.sleep(1)
