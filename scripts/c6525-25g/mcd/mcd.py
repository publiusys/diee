...
def run():
    ...
    if not is_running_mcd:
        print(f"rerunning mcd taskset numactl -N0 -m0 nice -20 taskset -c 0-15 ~/memcached/memcached -u nobody -L -k -Mm 82G -c 8192 -o hashpower=20 -b 8192 -l {TBENCH_SERVER} -B binary")
        #runRemoteCommands(f"taskset -c 0-15 ~/memcached/memcached -u nobody -t 16 -m 82G -c 8192 -o hashpower=20 -b 8192 -l {TBENCH_SERVER} -B binary -L", TBENCH_SERVER)
        runRemoteCommands(f"numactl -N0 -m0 nice -20 taskset -c 0-15 ~/memcached/memcached -u nobody -L -k -Mm 82G -c 8192 -o hashpower=20 -b 8192 -l {TBENCH_SERVER} -B binary", TBENCH_SERVER)
        time.sleep(1)
