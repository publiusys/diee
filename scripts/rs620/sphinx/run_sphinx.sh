...
function runOneDynamic
{
	...
	python sphinx.py --qps ${MQPS} --warmup ${MQPS} --maxq ${MAXQ} --nclients 3
    ...
    #rsync --mkpath -avz *.log don:/home/handong/cloudlab/xl170/sphinx/linux_dynamic/
    #rsync --mkpath -avz *.txt don:/home/handong/cloudlab/xl170/sphinx/linux_dynamic/
    #rsync --mkpath -avz *.bin don:/home/handong/cloudlab/xl170/sphinx/linux_dynamic/
}
