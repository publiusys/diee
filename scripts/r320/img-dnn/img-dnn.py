...
def setITR():
    ...
    p1 = runRemoteCommand(f"ethtool -C enp8s0d1 rx-frames {frames} rx-usecs {GITR}", TBENCH_SERVER)
    p1.communicate()
...
def run():
    ...
    serverOut = runRemoteCommand(f"TBENCH_SERVER_PORT=8080 TBENCH_SERVER={TBENCH_SERVER} TBENCH_WARMUPREQS={TBENCH_WARMUPREQS} TBENCH_MAXREQS={TBENCH_MAXREQS} TBENCH_NCLIENTS={TBENCH_NCLIENTS} ~/bayop/tailbench/img-dnn/img-dnn_server_networked -r 8 -f /data/tailbench.inputs/img-dnn/models/model.xml -n 100000000", TBENCH_SERVER)
    time.sleep(5)

    #clientOut1 = runLocalCommand(f"TBENCH_QPS={TBENCH_QPS} ~/bayop/tailbench/img-dnn/img-dnn_client_networked")
    clientOut1 = runRemoteCommand(f"TBENCH_SERVER_PORT=8080 TBENCH_SERVER={TBENCH_SERVER} TBENCH_MNIST_DIR=/data/tailbench.inputs/img-dnn/mnist TBENCH_QPS={TBENCH_QPS} ~/bayop/tailbench/img-dnn/img-dnn_client_networked", "192.168.1.1")
    ...
    clientOut3 = runRemoteCommand(f"TBENCH_SERVER_PORT=8080 TBENCH_SERVER={TBENCH_SERVER} TBENCH_MNIST_DIR=/data/tailbench.inputs/img-dnn/mnist TBENCH_QPS={TBENCH_QPS} ~/bayop/tailbench/img-dnn/img-dnn_client_networked", "192.168.1.3")
